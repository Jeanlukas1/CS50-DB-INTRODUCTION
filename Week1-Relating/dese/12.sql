...
-- In 12.sql, write a SQL query to find public school districts with above-average per-pupil expenditures and an above-average
-- percentage of teachers rated “exemplary”. Your query should return the districts’ names, along with their per-pupil expenditures
...
WHERE "districts"."state" = 'MA' AND "districts"."type" = 'Public School District'
