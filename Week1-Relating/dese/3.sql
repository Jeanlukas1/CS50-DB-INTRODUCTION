...
--  In 3.sql, write a SQL query to find the average per-pupil expenditure. Name the column
...
-- each district spent last year. You’ve been asked to find the average of this set of averages,
